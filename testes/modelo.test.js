...
test('Testando cadastro de resposta e recuperação de pergunta e respostas', () => {
  const idPergunta = modelo.cadastrar_pergunta('4 + 4 = ?');
  modelo.cadastrar_resposta(idPergunta, '8');
  ...
  expect(pergunta.texto).toBe('4 + 4 = ?');
